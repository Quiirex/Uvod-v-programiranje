...
{
    int deljenec = 0;
    int rezultat = 10 / deljenec; // To bo sprožilo System.DividedByZeroException
}
catch (DividedByZeroException ex)
{
    Console.WriteLine("Napaka: Delitev z ničlo ni mogoča. " + ex.Message);
}
catch (Exception ex)
{
...
{
    Console.WriteLine("Ta blok se vedno izvede, ne glede na to, ali je prišlo do izjeme ali ne.");
}
